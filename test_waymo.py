...
'''
Investigating the time efficiency of different scheduling stratiges on Waymo dataset.
'''
...
parser.add_argument("--input_file", type=str,
                    default="/home/sl29/data/Waymo/validation/" +
...
video_segment = tf.data.TFRecordDataset(args.input_file, compression_type='')
frame_list = []
...
# read and resize image, finally img is a ndarray format after resize and color conversion
