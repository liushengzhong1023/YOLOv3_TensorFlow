...
class yolov3(object):
    ...
    def forward(self, inputs, is_training=False, reuse=False):
        '''
        Definition of the neural network, inputs --> feature maps.
        '''
    ...
    def reorg_layer(self, feature_map, anchors):
        '''
        Given a feature map and anchors, reorganize the predictions of feature map. Used by predict function.
        feature_map: a feature_map from [feature_map_1, feature_map_2, feature_map_3] returned
            from `forward` function
        anchors: shape: [3, 2], we have 9 anchors in total in COCO, each feature map corresponds to 3 anchors.
        '''
        # NOTE: size in [h, w] format! don't get messed up! Get feature map size.
        ...
        # [batch, height, width, boxes_per_cell, box_coordinates + classes]
        ...
        # conf_logits: [N, 13, 13, 3, 1], aka IoU between pred_box and true_box
        ...
        # get the absolute box coordinates on the feature_map, and rescale to the original image scale
        ...
        # shape:
        # x_y_offset: [13, 13, 1, 2], cell position
    ...
    def predict(self, feature_maps):
        ...
        # get the corresponding anchors for each feature map
        ...
        # from center point position and box size to end points.
    ...
    def loss_layer(self, feature_map_i, y_true, anchors):
        '''
        Calculate loss function from a certain scale, used by compute_loss function.
        input:
    ...
    def box_iou(self, pred_boxes, valid_true_boxes):
        '''
        Compute the IoU between predicted boxes and ground truth boxes.
        param:
    ...
    def compute_loss(self, y_pred, y_true):
        '''
        A wrapper function for loss_layer across all feature maps.
        param:
