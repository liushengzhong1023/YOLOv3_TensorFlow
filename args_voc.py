...
save_dir = './checkpoint/VOC/'  # The directory of the weights to save.
log_dir = './data/logs/VOC/'  # The directory to store the tensorboard log files.
progress_log_path = './data/progress/VOC/progress.log'  # The path to record the training progress.
anchor_path = './data/yolo_anchors.txt'  # The path of the anchor txt file.
class_name_path = './data/my_data/VOC/voc.names'  # The path of the class names.
