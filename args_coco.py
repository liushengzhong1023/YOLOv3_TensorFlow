...
### Some paths
train_file = './data/my_data/COCO/train.txt'  # The path of the training txt file.
val_file = './data/my_data/COCO/val.txt'  # The path of the validation txt file.
restore_path = './data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
save_dir = './checkpoint/COCO/'  # The directory of the weights to save.
log_dir = './data/logs/COCO/'  # The directory to store the tensorboard log files.
progress_log_path = './data/progress/COCO/progress.log'  # The path to record the training progress.
anchor_path = './data/yolo_anchors.txt'  # The path of the anchor txt file.
class_name_path = './data/my_data/COCO/coco.names'  # The path of the class names.
